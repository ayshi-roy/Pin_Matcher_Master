...
function submitBtn(){
    ...
    if(randomNumber == screenInput){
        ...
        document.getElementById("pinMatchNotShow").style.display = 'none';
        
    }
    else if(randomNumber==0000 || screenInput==""){
        alert("Please include 4 digit value");               
        }
    else {
        document.getElementById("pinMatchNotShow").style.display = 'block';
            document.getElementById("pinMatchShow").style.display = 'none';
